...
class GraphScene(Scene):
    ...
    def get_riemann_rectangles_list(self,
                                    graph,
                                    n_iterations,
                                    max_dx=0.5,
                                    power_base=2,
                                    ...
                                    **kwargs):
        return [
            self.get_riemann_rectangles(graph=graph,
                                        dx=float(max_dx) / (power_base**n),
                                        stroke_width=float(stroke_width) /
                                        (power_base**n),
                                        **kwargs) for n in range(n_iterations)
        ]
    ...
    def get_vertical_line_to_graph(self,
        ...
        return line_class(self.coords_to_point(x, 0),
                          self.input_to_graph_point(x, graph), **line_kwargs)
    ...
    def get_secant_slope_group(
        ...
        if include_secant_line:
            ...
            group.secant_line.scale(secant_line_length /
